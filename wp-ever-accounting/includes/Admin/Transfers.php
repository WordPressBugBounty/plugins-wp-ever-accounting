...
class Transfers {
	...
	public static function register_tabs( $tabs ) {
		if ( current_user_can( 'eac_read_transfers' ) ) { // phpcs:ignore WordPress.WP.Capabilities.Unknown -- Custom capability.
	...
	public static function handle_edit() {
		...
		$transfer = EAC()->transfers->insert(
			array(
				...
				'transfer_date'      => isset( $_POST['transfer_date'] ) ? get_gmt_from_date( sanitize_text_field( wp_unslash( $_POST['transfer_date'] ) ) ) : '',
