		...
		foreach ( $this->notices as $notice ) {
			if ( $this->should_display( $notice ) ) {
				...
				printf(
					...
					$notice['dismissible'] ? '<button type="button" class="notice-dismiss"><span class="screen-reader-text">' . esc_html__( 'Dismiss this notice', 'wp-ever-accounting' ) . '</span></button>' : ''
				);
			}
		}
	}
