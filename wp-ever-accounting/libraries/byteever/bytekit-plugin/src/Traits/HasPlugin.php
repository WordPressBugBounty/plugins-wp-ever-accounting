...
namespace EverAccounting\ByteKit\Traits;
...
trait HasPlugin
{
    ...
    public function get_plugin_meta_links()
    {
        ...
        if (!empty($this->get_docs_url())) {
            $links['docs'] = array('label' => __('Documentation', 'bytekit-textdomain'), 'url' => $this->get_docs_url());
        }
        if (!empty($this->get_support_url())) {
            $links['support'] = array('label' => __('Support', 'bytekit-textdomain'), 'url' => $this->get_support_url());
        }
        if (!empty($this->get_review_url())) {
            $links['review'] = array('label' => __('Review', 'bytekit-textdomain'), 'url' => $this->get_review_url());
        }
        /**
    ...
    public function get_plugin_action_links()
    {
        ...
        if (!empty($this->get_settings_url())) {
            $links['settings'] = array('label' => __('Settings', 'bytekit-textdomain'), 'url' => $this->get_settings_url());
        }
        /**
